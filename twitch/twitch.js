...
const { token, Twitch_token, Discord_channel_ID, Twitch_channels } = require("./config.json");
...
const TWITCH_CHANNEL = Twitch_channels[0]["twitch_id"];
const DISCORD_CHANNEL_ID = Twitch_channels[0]["Discord_channel_ID"];
